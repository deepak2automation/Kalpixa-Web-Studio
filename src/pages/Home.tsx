  ...
  <>
    ...
    <div className="relative overflow-hidden bg-[#07111f]">
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_top,rgba(245,158,11,0.10),transparent_24%),radial-gradient(circle_at_82%_18%,rgba(168,85,247,0.07),transparent_22%),radial-gradient(circle_at_20%_80%,rgba(59,130,246,0.05),transparent_18%)]" />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-14 pb-10 sm:pt-16 sm:pb-12 lg:pt-20 lg:pb-14">
          <div className="grid lg:grid-cols-[0.94fr_1.06fr] gap-10 lg:gap-12 items-center">
            ...
            <div className="max-w-2xl">
              <h1 className="mt-2 sm:mt-3 font-serif text-[2.55rem] sm:text-[3.5rem] lg:text-[4.4rem] xl:text-[5rem] font-bold tracking-tight text-white leading-[0.95]">
                Transforming Local
              ...
              <div className="relative rounded-[30px] border border-white/10 bg-white/[0.05] p-3 sm:p-4 backdrop-blur-2xl shadow-[0_30px_90px_rgba(0,0,0,0.38)]">
                ...
                <div className="mt-3 grid grid-cols-1 sm:grid-cols-3 gap-3">
                  <div className="rounded-2xl border border-white/10 bg-white/[0.05] px-4 py-4">
                    ...
                    <div className="mt-1 text-white font-semibold text-[0.98rem]">
          ...
          <div className="mt-8 sm:mt-10 grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="rounded-2xl border border-white/10 bg-white/[0.045] px-5 py-5 backdrop-blur-xl">
              <div className="text-[11px] uppercase tracking-[0.22em] text-slate-500">
                Capability
              </div>
              <div className="mt-2 text-[1.35rem] font-semibold text-white">
                Next.js Expert
              </div>
            </div>
              ...
              <div>
                ...
                <h2 className="mt-4 font-serif text-[2.1rem] sm:text-[2.7rem] lg:text-[3.4rem] font-bold tracking-tight text-white leading-[0.98]">
                  ...
                  <span className="block mt-2">
                    It should elevate the business behind it.
                  </span>
                </h2>
              </div>
            ...
            <div className="grid lg:grid-cols-3 gap-6 lg:gap-8">
              {SERVICES.slice(0, 3).map((service) => (
                ...
                >
                  ...
                  <h3 className="mt-8 text-[1.55rem] font-bold text-white">
                    {service.title}
                  </h3>
