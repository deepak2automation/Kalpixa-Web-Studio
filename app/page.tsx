...
export default function Home() {
  return <main id="main-content">
    ...
    <section className="proof-section shell"><p className="eyebrow">Our operating standard</p><blockquote>“The goal is not to make a website look expensive. It is to make your business easier to understand, trust and choose.”</blockquote><p>— Kalpixa studio principle</p></section><CtaBand />
  </main>;
}
