...
export const metadata: Metadata = {
  ...
  openGraph: { type: 'website', locale: 'en_IN', url: '/', siteName: 'Kalpixa', title: 'Kalpixa — Digital clarity. Measurable growth.', description: 'Strategy, design, engineering and growth systems for ambitious service businesses.', images: [{ url: '/og-kalpixa.png', width: 1200, height: 630, alt: 'Kalpixa — Digital clarity. Measurable growth.' }] },
